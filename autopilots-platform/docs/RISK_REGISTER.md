...
| Scheduler impersonates a human owner | Critical | Authority profile is used only for live membership scope; every scheduled audit actor/source is `autopilots-health-monitor` | IAM: introduce dedicated service-account principals before production hosting |
