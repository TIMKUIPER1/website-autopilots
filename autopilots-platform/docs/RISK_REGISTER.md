...
| Multiple runtime instances duplicate scheduled probes | High | Deterministic time-bucket idempotency prevents duplicate health evidence per connector; in-process overlap is blocked | Platform: add a durable database lease before multi-instance hosting |
