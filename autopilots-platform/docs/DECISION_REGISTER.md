...
| 2026-08-03 | Do not download demo workspace state into managed browser sessions | Presentation guards are insufficient if internal sessions still receive demo agents and workflows; managed routes load only durable scoped projections while the customer demo remains separate | Accepted |
