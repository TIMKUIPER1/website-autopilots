...
export const researchKnowledgeArticles: KnowledgeArticle[] = [
  article({
    ...
    related: [{ label: "Product", title: "Bekijk de AI Telefoniste.", href: "/producten/ai-telefoniste/" }, { label: "Proces", title: "Zo testen we vóór livegang.", href: "/proces/" }, { label: "Afspraak", title: "Bespreek je telefoonroute.", href: "/afspraak/" }],
  ...
  article({
    ...
    related: [{ label: "Product", title: "Bekijk hoe AI Inboxmedewerker wordt ingericht.", href: "/producten/ai-inboxmedewerker/" }, { label: "Privacy", title: "Lees onze privacyinformatie.", href: "/privacy/" }, { label: "Proces", title: "Bekijk menselijke fallback in het proces.", href: "/proces/" }],
  ...
  article({
    ...
    related: [{ label: "Proces", title: "Bekijk hoe governance in livegang past.", href: "/proces/" }, { label: "Kennis", title: "Lees over AI Act-transparantie.", href: "/kennisbank/ai-act-2026-chatbot-melden-dat-het-ai-is/" }, { label: "Afspraak", title: "Breng rollen en risico's in kaart.", href: "/afspraak/" }],
  ...
  article({
    ...
    related: [{ label: "Proces", title: "Bekijk testen en livegang.", href: "/proces/" }, { label: "Product", title: "Bekijk de AI Inboxmedewerker.", href: "/producten/ai-inboxmedewerker/" }, { label: "Afspraak", title: "Ontwerp een eerste testset.", href: "/afspraak/" }],
  ...
  article({
    ...
    related: [{ label: "Product", title: "Bekijk AI Inboxmedewerker.", href: "/producten/ai-inboxmedewerker/" }, { label: "Proces", title: "Van architectuur naar AI-brein.", href: "/proces/" }, { label: "Afspraak", title: "Breng je bronnen in kaart.", href: "/afspraak/" }],
  ...
  article({
    ...
    related: [{ label: "Proces", title: "Bekijk het interactieve implementatieproces.", href: "/proces/" }, { label: "Product", title: "Bekijk AI Telefoniste.", href: "/producten/ai-telefoniste/" }, { label: "Kennis", title: "Lees hoe je agents test.", href: "/kennisbank/ai-agent-testen-voor-livegang-evals/" }],
  ...
  article({
    ...
    related: [{ label: "Product", title: "Bekijk Autopilots CRM.", href: "/producten/autopilots-crm/" }, { label: "Proces", title: "Bekijk koppelingen en architectuur.", href: "/proces/" }, { label: "Kennis", title: "Test acties met evals.", href: "/kennisbank/ai-agent-testen-voor-livegang-evals/" }],
  ...
  article({
    ...
    related: [{ label: "Product", title: "Bekijk AI Telefoniste.", href: "/producten/ai-telefoniste/" }, { label: "Privacy", title: "Lees onze privacyinformatie.", href: "/privacy/" }, { label: "Afspraak", title: "Bespreek een meertalige pilot.", href: "/afspraak/" }],
